...
class TestInstitutionalDeliveriesSector(TestCase):
    ...
    def test_child_health_monthly(self):
        ...
        self.assertEqual(data['obc_boys_48_72'], 1)
        self.assertEqual(data['general_boys_48_72'], 0)
        self.assertEqual(data['total_boys_48_72'], 1)
        self.assertEqual(data['general_girls_48_72'], 0)
        self.assertEqual(data['st_boys_48_72'], 0)
        self.assertEqual(data['total_girls_48_72'], 2)
        self.assertEqual(data['minority_girls_48_72_num'], 0)
        self.assertEqual(data['obc_girls_48_72'], 2)
        self.assertEqual(data['sc_girls_48_72'], 0)
        self.assertEqual(data['sc_boys_48_72'], 0)
        self.assertEqual(data['minority_boys_48_72_num'], 0)
    ...
    def test_child_health_monthly_multiple_locations(self):
        ...
        self.assertEqual(data_a48['obc_boys_48_72'], 0)
        self.assertEqual(data_a48['general_boys_48_72'], 0)
        self.assertEqual(data_a48['total_boys_48_72'], 0)
        self.assertEqual(data_a48['general_girls_48_72'], 0)
        self.assertEqual(data_a48['st_boys_48_72'], 0)
        self.assertEqual(data_a48['total_girls_48_72'], 0)
        self.assertEqual(data_a48['minority_girls_48_72_num'], 0)
        self.assertEqual(data_a48['obc_girls_48_72'], 0)
        self.assertEqual(data_a48['sc_girls_48_72'], 0)
        self.assertEqual(data_a48['sc_boys_48_72'], 0)
        self.assertEqual(data_a48['minority_boys_48_72_num'], 0)
        ...
        self.assertEqual(data_a3['obc_boys_48_72'], 1)
        self.assertEqual(data_a3['general_boys_48_72'], 0)
        self.assertEqual(data_a3['total_boys_48_72'], 1)
        self.assertEqual(data_a3['general_girls_48_72'], 0)
        self.assertEqual(data_a3['st_boys_48_72'], 0)
        self.assertEqual(data_a3['total_girls_48_72'], 2)
        self.assertEqual(data_a3['minority_girls_48_72_num'], 0)
        self.assertEqual(data_a3['obc_girls_48_72'], 2)
        self.assertEqual(data_a3['sc_girls_48_72'], 0)
        self.assertEqual(data_a3['sc_boys_48_72'], 0)
        self.assertEqual(data_a3['minority_boys_48_72_num'], 0)
