...
from custom.icds_reports.const import AGG_CCS_RECORD_CF_TABLE, AGG_THR_V2_TABLE, AGG_ADOLESCENT_GIRLS_REGISTRATION_TABLE, AGG_APP_VERSION_TABLE
...
class AggAwcDistributedHelper(BaseICDSAggregationDistributedHelper):
    ...
    def updates(self):
        ...
        # Aggregating app version and commcare version
        yield """
        UPDATE "{tablename}" agg_awc SET
