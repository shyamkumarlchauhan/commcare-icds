    ...
    def aggregate_query(self):
        ...
        INSERT INTO "{tablename}" (
          ...
          GROUP BY awcm.awc_id, awcm.block_id, awcm.supervisor_id, awcm.district_id, awcm.state_name,
                awcm.district_name, awcm.block_name, awcm.supervisor_name, awcm.awc_name, awcm.awc_site_code, 
                awcm.aww_name, awcm.contact_phone_number, awcm.wer_weighed_0_2, awcm.wer_eligible_0_2,
