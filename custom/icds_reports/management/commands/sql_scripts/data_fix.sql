...
SELECT
	...
	SUM(CASE WHEN chm.zscore_grading_hfa_recorded_in_month = 1 AND chm.zscore_grading_hfa = 1 THEN 1 ELSE 0 END) as zscore_grading_hfa_severe,
	SUM(chm.zscore_grading_hfa_recorded_in_month) as zscore_grading_hfa_recorded_in_month,
	SUM(CASE WHEN chm.current_month_nutrition_status = 'normal' THEN 1 ELSE 0 END) as nutrition_status_normal,
	SUM(CASE WHEN chm.current_month_nutrition_status = 'moderately_underweight' THEN 1 ELSE 0 END) as nutrition_status_moderately_underweight,
	SUM(CASE WHEN chm.current_month_nutrition_status = 'severely_underweight' THEN 1 ELSE 0 END) as nutrition_status_severely_underweight,
	SUM(chm.nutrition_status_weighed) as nutrition_status_weighed,
	SUM(chm.wer_eligible) - SUM(chm.nutrition_status_weighed) as nutrition_status_unweighed,
	...
	SUM(CASE WHEN (chm.born_in_month = 1 AND (chm.nutrition_status_weighed = 1 OR chm.low_birth_weight_born_in_month = 1)) THEN 1 ELSE 0 END) as weighed_and_born_in_month,
...
UPDATE "agg_child_health_{month}" agg_child_health
    SET wasting_moderate = ut.wasting_moderate,
        ...
        zscore_grading_hfa_severe = ut.zscore_grading_hfa_severe,
        zscore_grading_hfa_recorded_in_month = ut.zscore_grading_hfa_recorded_in_month,
        nutrition_status_normal = ut.nutrition_status_normal,
        nutrition_status_moderately_underweight = ut.nutrition_status_moderately_underweight,
        nutrition_status_severely_underweight = ut.nutrition_status_severely_underweight,
        nutrition_status_weighed = ut.nutrition_status_weighed,
        nutrition_status_unweighed = ut.nutrition_status_unweighed,
        weighed_and_height_measured_in_month = ut.weighed_and_height_measured_in_month,
        weighed_and_born_in_month = ut.weighed_and_born_in_month,
...
UPDATE "agg_child_health_{month}" agg_child_health
    ...
    from (
        ...
        SUM(zscore_grading_hfa_normal) as ut.zscore_grading_hfa_normal,
        SUM(zscore_grading_hfa_moderate) as ut.zscore_grading_hfa_moderate,
        SUM(zscore_grading_hfa_severe) as ut.zscore_grading_hfa_severe,
        SUM(zscore_grading_hfa_recorded_in_month) as ut.zscore_grading_hfa_recorded_in_month,
        SUM(nutrition_status_normal) as ut.nutrition_status_normal,
        SUM(nutrition_status_moderately_underweight) as ut.nutrition_status_moderately_underweight,
        SUM(nutrition_status_severely_underweight) as ut.nutrition_status_severely_underweight,
        SUM(nutrition_status_weighed) as ut.nutrition_status_weighed,
        SUM(nutrition_status_unweighed) as ut.nutrition_status_unweighed,
        ...
        WHERE agg_child.aggregation_level=5 AND agg_child.state_id='96dacff698ed4ea2be48a5c952646114' AND agg_child.supervisor_id = '91e033b10a8441e0adfb87e27467cb2d'
    ...
    WHERE agg_child_health.supervisor_id = ut.supervisor_id and 
      ...
      agg_child_health.aggregation_level=4;
...
UPDATE "agg_child_health_{month}" agg_child_health
    ...
    from (
        ...
        SUM(height_measured_in_month) as ut.height_measured_in_month
        FROM "agg_child_health_{month}" agg_child
        WHERE agg_child.aggregation_level=4 AND agg_child.state_id='96dacff698ed4ea2be48a5c952646114' AND agg_child.block_id='0ee077e98e594d1eb471dfe4978b38e9'
        GROUP BY state_id, district_id,block_id, gender, age_tranche
    ) ut 
    WHERE agg_child_health.block_id = ut.block_id and 
      agg_child_health.gender = ut.gender AND
      agg_child_health.age_tranche = ut.age_tranche AND
      agg_child_health.aggregation_level=3;
...
UPDATE "agg_child_health_{month}" agg_child_health
    ...
    from (
        ...
        SUM(height_measured_in_month) as ut.height_measured_in_month
        FROM "agg_child_health_{month}" agg_child
        WHERE agg_child.aggregation_level=3 AND agg_child.state_id='96dacff698ed4ea2be48a5c952646114' AND agg_child.district_id='e92cd85ec16e42c493dec30273333923'
        GROUP BY state_id, district_id,gender, age_tranche
    ) ut 
    WHERE agg_child_health.district_id = ut.district_id and 
      agg_child_health.gender = ut.gender AND
      agg_child_health.age_tranche = ut.age_tranche AND
      agg_child.aggregation_level=2;
