...
class Command(BaseCommand):
    def handle(self, **options):
        ...
        child_report = prepare_excel_reports(config, aggregation_level, include_test, False, '', 'icds-cas',
                                             export_format,
                                             indicator)
        ...
        indicator = 5
        awc_infrastructure_report = prepare_excel_reports(config, aggregation_level, include_test, False, '',
                                                          'icds-cas',
                                                          export_format, indicator)
        ...
        sdr_pw_lw_children_report = prepare_excel_reports(config, aggregation_level, include_test, False, '',
                                                          'icds-cas',
                                                          export_format, indicator)
        ...
        ppr_report = prepare_excel_reports(config, aggregation_level, include_test, False, '', 'icds-cas',
                                           export_format,
                                           indicator)
