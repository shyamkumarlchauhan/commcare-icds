...
describe('Infants Weight Scale Directive', function () {

    var $scope, $httpBackend, $location, controller, controllermapOrSectorView;

    pageData.registerUrl('icds-ng-template', 'template');
    pageData.registerUrl('infants_weight_scale', 'infants_weight_scale');
    ...
    beforeEach(inject(function ($rootScope, $compile, _$httpBackend_, _$location_) {
        ...
        $httpBackend.expectGET('infants_weight_scale').respond(200, {
        ...
        $httpBackend.flush();
        $scope.$digest();
        controller = compiled.controller('infantsWeightScale');
        controller.step = 'map';
    ...
    it('tests chart options', function () {
        ...
        assert.equal(controller.chartOptions.caption.html,
            ...
            'last 6 months, the percentage of AWCs that reported having a weighing scale for infants'
        );
    });
    ...
    it('tests horizontal chart tooltip content', function () {
        var expected = '<div class="hoverinfo" style="max-width: 200px !important; white-space: normal;">' +
            ...
            '<div>Percentage of AWCs that reported having a weighing scale for infants: <strong>0.00%</strong></div></div>';
