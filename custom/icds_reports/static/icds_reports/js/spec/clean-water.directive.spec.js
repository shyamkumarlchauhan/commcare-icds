...
describe('Clean Water Directive', function () {
    ...
    pageData.registerUrl('clean_water', 'clean_water');
    ...
    it('tests supervisor location', function () {
        ...
        $httpBackend.expectGET('clean_water?location_id=test-id').respond(200, {
            report_data: ['report_test_data'],
        });
        controller.init();
        $httpBackend.flush();
    ...
    it('tests template popup', function () {
        ...
        var expected = '<div class="hoverinfo" style="max-width: 200px !important; white-space: normal;"><p>test</p>' +
            ...
            '<div>% of AWCs that reported having a source of clean drinking water: <strong>10.00%</strong></div></div>';
    ...
    it('tests chart options', function () {
        ...
        assert.equal(controller.chartOptions.caption.html,
            ...
            'last 6 months, the percentage of AWCs that reported having a source of clean drinking water. '
        );
    });
    ...
    it('tests horizontal chart tooltip content', function () {
        var expected = '<div class="hoverinfo" style="max-width: 200px !important; white-space: normal;">' +
            ...
            '<div>% of AWCs that reported having a source of clean drinking water: <strong>0.00%</strong></div></div>';
