...
CREATE VIEW child_health_monthly_view AS
  SELECT
      ...
      child_health_monthly.last_recorded_weight,
      child_health_monthly.last_recorded_height,
      child_health_monthly.last_referral_date,
      child_health_monthly.referral_health_problem,
      child_health_monthly.referral_reached_date,
      child_health_monthly.last_referral_discharge_date,
      child_health_monthly.sam_mam_visit_date_1,
      child_health_monthly.sam_mam_visit_date_2,
      child_health_monthly.sam_mam_visit_date_3,
      child_health_monthly.sam_mam_visit_date_4,
      child_health_monthly.poshan_panchayat_date_1,
      child_health_monthly.poshan_panchayat_date_2,
      child_health_monthly.poshan_panchayat_date_3,
      child_health_monthly.poshan_panchayat_date_4,
