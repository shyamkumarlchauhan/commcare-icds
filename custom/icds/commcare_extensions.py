...
from corehq.apps.reports.extension_points import emwf_options_user_query_mutators
...
@emwf_options_user_query_mutators.extend()
def icds_emwf_options_user_query_mutators(domain):
    from custom.icds.report_filters import filter_emwf_options_test_users
    return [
        filter_emwf_options_test_users,
    ]
